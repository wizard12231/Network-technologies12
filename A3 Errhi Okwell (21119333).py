...
def main():
    while True:
        ...
        if choice == "1":
            ...
            current_config = input("Enter your current running configuration: ")
            startup_config = input("Enter your startup configuration: ")
            compare_configurations(current_config, startup_config)

        elif choice == "4":
            your_ip_address = input("Enter your device IP: ")
            your_username = input("Enter your username: ")
            your_password = input("Enter your password: ")
            your_enable_password = input("Enter your enable password: ")
            ...
            your_password = input("Enter your password: ")
            your_enable_password = input("Enter your enable password: ")
            protocol_choice = input("Enter the routing protocol (ospf/eigrp/rip): ").lower()
